...
export const BloksDocumentUpdateArgsSchema: z.ZodType<Prisma.BloksDocumentUpdateArgs> = z.object({
  select: BloksDocumentSelectSchema.optional(),
  include: BloksDocumentIncludeSchema.optional(),
  data: z.union([ BloksDocumentUpdateInputSchema,BloksDocumentUncheckedUpdateInputSchema ]),
  where: BloksDocumentWhereUniqueInputSchema,
}).strict() ;

export default BloksDocumentUpdateArgsSchema;

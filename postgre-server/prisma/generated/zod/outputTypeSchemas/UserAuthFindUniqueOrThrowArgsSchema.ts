...
export const UserAuthFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.UserAuthFindUniqueOrThrowArgs> = z.object({
  select: UserAuthSelectSchema.optional(),
  include: UserAuthIncludeSchema.optional(),
  where: UserAuthWhereUniqueInputSchema,
}).strict() ;

export default UserAuthFindUniqueOrThrowArgsSchema;

...
export const BlokUpdateArgsSchema: z.ZodType<Prisma.BlokUpdateArgs> = z.object({
  select: BlokSelectSchema.optional(),
  include: BlokIncludeSchema.optional(),
  data: z.union([ BlokUpdateInputSchema,BlokUncheckedUpdateInputSchema ]),
  where: BlokWhereUniqueInputSchema,
}).strict() ;

export default BlokUpdateArgsSchema;

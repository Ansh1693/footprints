				...
				<div>
					{data && (
						<div className='space-y-6'>
							...
							{data.documentMetadata.document_type ===
								'audio' && (
							...
							<p>
								...
								duis labore eiusmod sint laboris commodo
								occaecat. Lorem in aute nostrud ut. Nostrud
								voluptate in officia occaecat velit qui culpa
								fugiat quis laborum cupidatat dolor pariatur.
								Consectetur velit consequat aliqua. Qui eiusmod
								labore incididunt nostrud irure enim velit eu
								nostrud. In id magna velit. Aliquip duis aliqua
								eu minim in excepteur. Quis nostrud nostrud
								incididunt aliqua ipsum enim qui duis labore
								eiusmod sint laboris commodo occaecat. Lorem in
								aute nostrud ut. Nostrud voluptate in officia
								occaecat velit qui culpa fugiat quis laborum
								...
								velit. Aliquip duis aliqua eu minim in
								excepteur. Quis nostrud nostrud incididunt
								aliqua ipsum enim qui duis labore eiusmod sint
								laboris commodo occaecat. Lorem in aute nostrud
								ut. Nostrud voluptate in officia occaecat velit
								qui culpa fugiat quis laborum cupidatat dolor
								pariatur. Consectetur velit consequat aliqua.
								Qui eiusmod labore incididunt nostrud irure enim
								velit eu nostrud. In id magna velit. Aliquip
								duis aliqua eu minim in excepteur. Quis nostrud
								nostrud incididunt aliqua ipsum enim qui duis
								labore eiusmod sint laboris commodo occaecat.
								Lorem in aute nostrud ut. Nostrud voluptate in
								officia occaecat velit qui culpa fugiat quis
								laborum cupidatat dolor pariatur. Consectetur
								velit consequat aliqua. Qui eiusmod labore
								incididunt nostrud irure enim velit eu nostrud.
								In id magna velit. Aliquip duis aliqua eu minim
								in excepteur. Quis nostrud nostrud incididunt
								aliqua ipsum enim qui duis labore eiusmod sint
								laboris commodo occaecat. Lorem in aute nostrud
								ut. Nostrud voluptate in officia occaecat velit
								qui culpa fugiat quis laborum cupidatat dolor
							...
							<div className='flex items-center gap-3 p-4 border-b'>
								<div className='p-[1px] rounded-[6px] gradient-border h-[31px] w-full'>
									<Input
										...
										className={
											'text-[12px] w-full text-primary border-none h-full rounded-[6px]'
										}
									/>
								</div>
								<Button className={'text-xs font-normal w-20'}>
									Add
								</Button>
							</div>

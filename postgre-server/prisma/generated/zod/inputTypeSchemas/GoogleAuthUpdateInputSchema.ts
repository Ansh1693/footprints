...
import { UserAuthUpdateOneRequiredWithoutGoogleAuthNestedInputSchema } from './UserAuthUpdateOneRequiredWithoutGoogleAuthNestedInputSchema';
...
export const GoogleAuthUpdateInputSchema: z.ZodType<Prisma.GoogleAuthUpdateInput> = z.object({
  ...
  UserAuth: z.lazy(() => UserAuthUpdateOneRequiredWithoutGoogleAuthNestedInputSchema).optional()
}).strict();

...
export const GoogleAuthFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.GoogleAuthFindUniqueOrThrowArgs> = z.object({
  select: GoogleAuthSelectSchema.optional(),
  include: GoogleAuthIncludeSchema.optional(),
  where: GoogleAuthWhereUniqueInputSchema,
}).strict() ;

export default GoogleAuthFindUniqueOrThrowArgsSchema;

...
export const UserAuthCreateArgsSchema: z.ZodType<Prisma.UserAuthCreateArgs> = z.object({
  select: UserAuthSelectSchema.optional(),
  include: UserAuthIncludeSchema.optional(),
  data: z.union([ UserAuthCreateInputSchema,UserAuthUncheckedCreateInputSchema ]),
}).strict() ;

export default UserAuthCreateArgsSchema;

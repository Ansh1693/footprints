...
export const DocumentMetadataUpdateArgsSchema: z.ZodType<Prisma.DocumentMetadataUpdateArgs> = z.object({
  select: DocumentMetadataSelectSchema.optional(),
  include: DocumentMetadataIncludeSchema.optional(),
  data: z.union([ DocumentMetadataUpdateInputSchema,DocumentMetadataUncheckedUpdateInputSchema ]),
  where: DocumentMetadataWhereUniqueInputSchema,
}).strict() ;

export default DocumentMetadataUpdateArgsSchema;

...
export const BlokFollowersUpsertArgsSchema: z.ZodType<Prisma.BlokFollowersUpsertArgs> = z.object({
  ...
  create: z.union([ BlokFollowersCreateInputSchema,BlokFollowersUncheckedCreateInputSchema ]),
  update: z.union([ BlokFollowersUpdateInputSchema,BlokFollowersUncheckedUpdateInputSchema ]),
}).strict() ;

export default BlokFollowersUpsertArgsSchema;
